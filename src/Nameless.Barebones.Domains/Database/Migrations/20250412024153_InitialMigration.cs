        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasswordHash = table.Column<string>(type: "TEXT", maxLength: 4096, nullable: true),
                    SecurityStamp = table.Column<string>(type: "TEXT", maxLength: 4096, nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "TEXT", maxLength: 2147483647, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClaimType = table.Column<string>(type: "TEXT", maxLength: 4096, nullable: true),
                    ClaimValue = table.Column<string>(type: "TEXT", maxLength: 4096, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LoginProvider = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    ProviderKey = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    ProviderDisplayName = table.Column<string>(type: "TEXT", maxLength: 4096, nullable: true),
                    UserId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
