...
public sealed class StackOverflow : Icon {
    private const string Svg = """
                               <?xml version="1.0" encoding="UTF-8"?>
                               <svg width="{0}px" height="{0}px" viewBox="-24 0 304 304" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                                   <g>
    ...
    public StackOverflow(IconSize size = IconSize.Size16)
        : base(name: "stackoverflow",
               variant: IconVariant.Color,
               size: size != IconSize.Custom ? size : IconSize.Size16,
               content: string.Format(Svg, (int)(size != IconSize.Custom ? size : IconSize.Size16))) { }
}
